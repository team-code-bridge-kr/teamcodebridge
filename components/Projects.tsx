...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-24 bg-gray-950 overflow-hidden">
        ...
        >
          ...
          {projects.map((project, index) => (
            <motion.div
              ...
              className={`flex-shrink-0 w-[320px] md:w-[360px] snap-center cursor-pointer group transition-all duration-300 ${currentIndex === index ? 'scale-100' : 'scale-95 opacity-70'
                }`}
              onClick={() => setCurrentIndex(index)}
            >
              <div className={`h-full bg-gradient-to-br ${project.gradient} rounded-3xl p-8 relative overflow-hidden`}>
                {/* Background pattern */}
