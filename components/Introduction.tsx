            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col items-center text-center">
                    ...
                    <motion.h2
                        ...
                        className="text-3xl md:text-5xl font-bold text-gray-900 mb-10 leading-tight text-balance"
                    >
                    ...
                    >
                        <p className="text-gray-600 text-lg md:text-xl leading-relaxed font-medium">
                            ...
                            해결하는 <span className="text-gray-900 font-bold">'메이커'</span>로 성장할 수 있도록 돕는 대학생 비영리 단체입니다.
                    ...
                    <motion.div
                        ...
                        className="mt-12 w-16 h-1 bg-brand rounded-full"
                    />
                </div>
            </div>
